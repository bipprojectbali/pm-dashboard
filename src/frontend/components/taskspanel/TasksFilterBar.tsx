        ...
        <Group gap="sm" wrap="wrap" align="center">
          {activeProject ? (
            <Badge
              ...
              rightSection={
                <ActionIcon size="xs" variant="transparent" color="blue" onClick={() => onProjectChange(null)} aria-label="Clear project filter">
                  <TbX size={12} />
                </ActionIcon>
              }
            >
          ...
          <Switch label="Assigned to me" checked={mine} onChange={(e) => onMineChange(e.currentTarget.checked)} size="sm" />
        </Group>
