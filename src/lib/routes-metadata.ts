...
export const ROUTES_METADATA: RouteMetadata[] = [
  ...
  },
  {
    ...
    auth: 'authenticated',
    category: 'pm-watch',
    description: "Current user's own pm-watch agents",
  },
  {
    method: 'GET',
    ...
    auth: 'authenticated',
    category: 'pm-watch',
    description: 'Total window-bucket seconds tracked today',
  },
  {
    method: 'GET',
  ...
  },
  {
    ...
    description: 'List notifications (?limit=50&unread=1)',
  },
  {
    method: 'GET',
  ...
  },
  {
    ...
    auth: 'authenticated',
    category: 'team',
    description: "Recent task activity in user's shared projects",
  },
  {
    method: 'GET',
  ...
  },
  {
    ...
    auth: 'authenticated',
    category: 'projects',
    description: 'Delete project permanently (OWNER or SUPER_ADMIN)',
  },
  {
    method: 'POST',
  ...
  },
  {
    ...
    auth: 'authenticated',
    category: 'tasks',
    description: 'List tasks (filter: projectId, status, kind, assigneeId, mine=1)',
  },
  {
    method: 'POST',
    path: '/api/tasks',
  ...
  },
  {
    ...
    auth: 'authenticated',
    category: 'github',
    description: 'GitHub repo stats for project',
  },
  {
    method: 'GET',
    ...
    auth: 'authenticated',
    category: 'github',
    description: 'Paginated GitHub events for project',
  },
  {
    method: 'POST',
  ...
  },
  {
    ...
    auth: 'shared-secret',
    category: 'mcp',
    description: 'MCP HTTP fallback (Bearer MCP_SECRET; scope by NODE_ENV)',
  },
  {
    method: 'GET',
  ...
  },
  {
    ...
    auth: 'authenticated',
    category: 'tasks',
    description: 'Rename/recolor tag',
  },
  ...
  },
  {
    ...
    auth: 'authenticated',
    category: 'activity',
    description: 'List my ActivityWatch events',
  },
  {
    method: 'GET',
    ...
    auth: 'authenticated',
    category: 'activity',
    description: 'Aggregate stats for my AW events',
  },
  {
    method: 'GET',
    ...
    auth: 'authenticated',
    category: 'activity',
    description: 'List my approved pm-watch agents',
  },
  {
    method: 'GET',
    ...
    auth: 'authenticated',
    category: 'activity',
    description: 'Per-day event counts for a month',
  },
  {
    method: 'GET',
    ...
    auth: 'authenticated',
    category: 'activity',
    description: 'Per-day activity aggregates for a full year',
  },
