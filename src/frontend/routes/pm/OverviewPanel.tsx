            ...
            <Group gap="xs" mb="md">
              ...
              <div style={{ flex: 1 }}>
                <Group gap="xs">
                  ...
                  <InfoTip
                    label="Rangkuman kilat 7 hari terakhir: task closed, yang in-progress, bug baru, dan total task aktif."
                    size={12}
                  />
                </Group>
                ...
                <UnstyledButton
                  ...
                  onClick={() => {
                    if (n.taskId) {
                      navigate({
                        to: '/pm',
                        search: { tab: 'tasks', taskId: n.taskId, ...(n.projectId ? { projectId: n.projectId } : {}) },
                      })
                    } else if (n.projectId) {
      ...
      <Paper withBorder p="lg" radius="md">
        <Group justify="space-between" mb="md">
          <Group gap="xs">
            ...
            <InfoTip
              label="Daftar singkat proyek aktif yang kamu miliki atau ikuti. Max 5 ditampilkan. Klik nama proyek untuk buka detail."
              size={12}
            />
          </Group>
          <Group gap="xs">
